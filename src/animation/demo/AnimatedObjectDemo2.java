 ...
 * small black circle that moves from left to right across the window. It
 * stops moving if it hits another object.
 *
 */
public class AnimatedObjectDemo2 implements AnimatedObject {
     ...
     */
    public AnimatedObjectDemo2(AbstractAnimation animation) {
